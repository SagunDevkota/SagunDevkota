...
🌐 https://sagundevkota.com.np
<h3 align="center">A passionate Python Developer from Nepal.</h3>


Python backend developer focused on building reliable, scalable systems.

- 🚀 Specialize in **Django**, **REST APIs**, and backend architecture
- 🧠 Strong focus on **data workflows**, ML experimentation, and system design
- 🗄️ Experienced with **PostgreSQL**, distributed services, and API-heavy applications
- ⚙️ Interested in performance optimization and clean software engineering practices
- 💬 Ask me about **Python**, backend systems, and data-driven applications
- 📫 sagundevyt@gmail.com | sagundevkota07@gmail.com
